...
const HOST = "https://atiny.top"; // 线上服务器地址，如果不使用请留空

const BLOG_NAME = "inFinity"; // 个人网站名字

const BLOG_URL = "https://blog.atiny.top"; // 个人网站链接（请填写完整链接）
...
const RECORD_NUMBER = "豫ICP备520520520号"; // 网站备案号，留空不显示
